...
`,x=`El Juego de la Vida de Conway: Predicción Inversa con Algoritmos Genéticos
...
`,A=`<div style="display: flex; justify-content: center; text-align: center;">
...
`,D=`<h1>Búsqueda de Patrones en Ventas de Comida Rápida: Explorando lo Invisible</h1>
<br><br>
...
`,M=`<h1>Predicción de Ventas con Deep Learning y Generación de Datos Sintéticos</h1>
<br><br>
...
`,S=`¿Cómo ha cambiado la distribución socioeconómica de los estudiantes universitarios en Chile en la última década? En este proyecto, utilizo datos del [DEMRE](https://demre.cl/portales/portal-bases-datos) para crear visualizaciones que exploran el origen escolar y el rendimiento académico de los estudiantes.
...
`;function o(s,l,d=p){return l.forEach(r=>{const c=new RegExp(`\\$\\{AssetsImage\\.${r}\\}`,"g");s=s.replace(c,d[r])}),s}const t={VizDemre:o(S,["VizDemreTer","VizDemreScatter","VizDemreTerSvelte"]),ComidaIV:o(M,["ComidaDLVae","ComidaDLReg","ComidaDLRF","ComidaDLDLArq","ComidaDLDLRes","ComidaDLCNNArq","ComidaDLCNNRes","ComidaDLCNNVaeRes","ComidaDLCNNPred"]),ComidaIII:o(D,["ComidaPCA","ComidaISOMAP","ComidaTSNE","ComidaSOMcom"]),ComidaII:o(A,["ComidaDist","ComidaRegL","ComidaKNN","ComidaSVM","ComidaRF","ComidaGB"]),ComidaI:o(w,["ComidaAnalisis"]),Volcanic:o(C,["INGVPred"]),Kaggle2020:o(I,["K2020Req","K2020RankC","K2020ReqAge","K2020ComR","K2020ComA"]),GameLife:o(x,["GLifeStartStop","GLifePred"]),SomClassify:o(b,["SomGral","SomMNIST","SomDistNum","SomMatrixNum","SomFace","SomDistFace","SomMatrixFace"]),Fifa19:o(v,["FIFA19Age","FIFA19Club","FIFA19AgeGan","FIFA19Money","FIFA19Pred"]),RemFut:f,InfCardiaco:h,ConsumMall:y,NoticiaChile:u,PortfolioSvelte:g},a={VizDemre:"Visualizando la Diversidad Socioeconómica en la Educación Superior Chilena",ComidaIV:"Predicción de Ventas con Deep Learning y Datos Sintéticos en Comida Rápida (Parte IV)",ComidaIII:"Descubriendo Patrones Ocultos en Ventas de Comida Rápida con Aprendizaje No Supervisado (Parte III)",ComidaII:"Predicción de Ventas Semanales en Comida Rápida con Machine Learning (Parte II)",ComidaI:"Planificación Inteligente de Ventas en Comida Rápida: Análisis Exploratorio y Simulación (Parte I)",Volcanic:"Anticipando Erupciones Volcánicas con Machine Learning",Kaggle2020:"Panorama Global de la Ciencia de Datos: Análisis de la Encuesta Kaggle 2020",GameLife:"Resolviendo el Juego de la Vida Inverso con Algoritmos Genéticos",SomClassify:"Clasificación y Visualización de Imágenes con Mapas Autoorganizados (SOM)",Fifa19:"Predicción de Remuneraciones y Análisis de Datos en FIFA 19",RemFut:"Predicción de Salarios de Futbolistas a partir de Habilidades con IA",InfCardiaco:"Inteligencia Artificial para la Detección Temprana de Infarto Cardíaco",ConsumMall:"Predicción de Satisfacción de Clientes en Centros Comerciales con Machine Learning",NoticiaChile:"Radiografía Emocional de los Noticieros Chilenos en Twitter",PortfolioSvelte:"Svelte: Framework Moderno para Aplicaciones Web Eficientes"},j=[{slug:"dataviz-matricula-demre",color:"steelblue",description:t.VizDemre,shortDescription:"Utilizando datos de ingreso y matrícula del DEMRE se realizan 2 visualizaciones que permiten analizar el estado en estos últimos 10 años de la distribución socioecónomoica de los estudiantes.",links:[{to:"https://github.com/desareca/DataViz-Matricula-Demre",label:"Repositorio"},{to:"https://desareca.github.io/DataViz-Matricula-Demre/",label:"Grafico Interactivo"}],logo:i.Python,name:a.VizDemre,period:{from:new Date(2025,1,5),to:new Date(2025,3,30)},skills:n("python","pandas","numpy","matplotlib","svelte","d3js"),type:"Análisis de Datos",screenshots:[]},{slug:"venta-comida-rapida-4",color:"steelblue",description:t.ComidaIV,shortDescription:"Busqueda de Patrones utilizando herramientas de deep learning",links:[{to:"https://colab.research.google.com/drive/18JFP09N0xWcBOtIUZYPHgAdcuKqQk4yo#scrollTo=D1J1UYzNW67C",label:a.ComidaI},{to:"https://colab.research.google.com/drive/1hZTWo7pMp7SQ4lD3nCYMmZHfiXkb3TFB#scrollTo=A8NGJQD5uqn3",label:a.ComidaII},{to:"https://colab.research.google.com/drive/1jHPntGoAqJ3b6CeffmmgDpeHlv-NS0TQ#scrollTo=dTFGMi0MIXih",label:a.ComidaIII},{to:"https://colab.research.google.com/drive/12WJaWLLVgmc-jrzu4ibFcjx3C_i0d_hy#scrollTo=G6XKIhQSV6Ms",label:a.ComidaIV}],logo:i.Python,name:a.ComidaIV,period:{from:new Date(2022,1,5),to:new Date(2022,4,30)},skills:n("python","pandas","numpy","matplotlib","seaborn","sklearn","keras","tensorflow"),type:"Machine Learning",screenshots:[]},{slug:"venta-comida-rapida-3",color:"steelblue",description:t.ComidaIII,shortDescription:"Busqueda de Patrones utilizando herramientas de aprendizaje no supervisado",links:[{to:"https://colab.research.google.com/drive/18JFP09N0xWcBOtIUZYPHgAdcuKqQk4yo#scrollTo=D1J1UYzNW67C",label:a.ComidaI},{to:"https://colab.research.google.com/drive/1hZTWo7pMp7SQ4lD3nCYMmZHfiXkb3TFB#scrollTo=A8NGJQD5uqn3",label:a.ComidaII},{to:"https://colab.research.google.com/drive/1jHPntGoAqJ3b6CeffmmgDpeHlv-NS0TQ#scrollTo=dTFGMi0MIXih",label:a.ComidaIII},{to:"https://colab.research.google.com/drive/12WJaWLLVgmc-jrzu4ibFcjx3C_i0d_hy#scrollTo=G6XKIhQSV6Ms",label:a.ComidaIV}],logo:i.Python,name:a.ComidaIII,period:{from:new Date(2022,1,5),to:new Date(2022,4,30)},skills:n("python","pandas","numpy","matplotlib","seaborn","sklearn"),type:"Machine Learning",screenshots:[]},{slug:"venta-comida-rapida-2",color:"steelblue",description:t.ComidaII,shortDescription:"Predicción de Ventas utilizando algoritmos de Machine Learning",links:[{to:"https://colab.research.google.com/drive/18JFP09N0xWcBOtIUZYPHgAdcuKqQk4yo#scrollTo=D1J1UYzNW67C",label:a.ComidaI},{to:"https://colab.research.google.com/drive/1hZTWo7pMp7SQ4lD3nCYMmZHfiXkb3TFB#scrollTo=A8NGJQD5uqn3",label:a.ComidaII},{to:"https://colab.research.google.com/drive/1jHPntGoAqJ3b6CeffmmgDpeHlv-NS0TQ#scrollTo=dTFGMi0MIXih",label:a.ComidaIII},{to:"https://colab.research.google.com/drive/12WJaWLLVgmc-jrzu4ibFcjx3C_i0d_hy#scrollTo=G6XKIhQSV6Ms",label:a.ComidaIV}],logo:i.Python,name:a.ComidaII,period:{from:new Date(2022,1,5),to:new Date(2022,4,30)},skills:n("python","pandas","numpy","matplotlib","seaborn","sklearn"),type:"Machine Learning",screenshots:[]},{slug:"venta-comida-rapida-1",color:"steelblue",description:t.ComidaI,shortDescription:"Planificación Inteligente de Ventas en Comida Rápida: Análisis Exploratorio y Simulación",links:[{to:"https://colab.research.google.com/drive/18JFP09N0xWcBOtIUZYPHgAdcuKqQk4yo#scrollTo=D1J1UYzNW67C",label:a.ComidaI},{to:"https://colab.research.google.com/drive/1hZTWo7pMp7SQ4lD3nCYMmZHfiXkb3TFB#scrollTo=A8NGJQD5uqn3",label:a.ComidaII},{to:"https://colab.research.google.com/drive/1jHPntGoAqJ3b6CeffmmgDpeHlv-NS0TQ#scrollTo=dTFGMi0MIXih",label:a.ComidaIII},{to:"https://colab.research.google.com/drive/12WJaWLLVgmc-jrzu4ibFcjx3C_i0d_hy#scrollTo=G6XKIhQSV6Ms",label:a.ComidaIV}],logo:i.Python,name:a.ComidaI,period:{from:new Date(2022,1,5),to:new Date(2022,4,30)},skills:n("python","pandas","numpy","matplotlib"),type:"Análisis de Datos",screenshots:[]},{slug:"prediccion-erupcion-volcanica",color:"royalblue",description:t.Volcanic,shortDescription:"Predicción de erupciones volcánicas con XGBoost",links:[{to:"https://www.kaggle.com/code/desareca/automl-volcanic-eruption-prediction",label:"Kaggle"}],logo:i.R,name:a.Volcanic,period:{from:new Date(2020,10,11),to:new Date(2021,0,5)},skills:n("r","tidyverse","ggplot2"),type:"Series de Tiempo",screenshots:[]},{slug:"kaggle-survey-2020",color:"royalblue",description:t.Kaggle2020,shortDescription:"Visualización de datos de la encuesta Kaggle 2020 sobre ciencia de datos y aprendizaje automático.",links:[{to:"https://www.kaggle.com/code/desareca/kaggle-survey-2020-analisys-by-region",label:"Kaggle"}],logo:i.R,name:a.Kaggle2020,period:{from:new Date(2020,10,19),to:new Date(2021,0,5)},skills:n("r","tidyverse","ggplot2","plotly"),type:"Visualización de Datos",screenshots:[]},{slug:"game-life-genetic-algorithm",color:"royalblue",description:t.GameLife,shortDescription:"Optimización mediante algoritmos genéticos para resolver el juego de la vida inverso.",links:[{to:"https://www.kaggle.com/code/desareca/game-of-life-genetic-algorithm-spanish",label:"Kaggle"}],logo:i.R,name:a.GameLife,period:{from:new Date(2020,9,3),to:new Date(2020,9,31)},skills:n("r","tidyverse","ggplot2"),type:"Optimización - Algoritmos Genéticos",screenshots:[]},{slug:"som-clasificacion-imagenes",color:"royalblue",description:t.SomClassify,shortDescription:"Clasificación de imágenes mediante mapas autorganizados de Kohonen.",links:[{to:"https://rpubs.com/desareca/SOM_clasificacion_imagenes",label:"RPubs"}],logo:i.R,name:a.SomClassify,period:{from:new Date(2019,9,1),to:new Date(2019,9,31)},skills:n("r","tidyverse","ggplot2"),type:"Análisis de Datos",screenshots:[]},{slug:"fifa19-analisis-prediccion",color:"royalblue",description:t.Fifa19,shortDescription:"FIFA 19 (de la saga FIFA) es un videojuego de simulación de fútbol desarrollado por EA Vancouver como parte de la serie FIFA de Electronic Arts.",links:[{to:"https://www.kaggle.com/code/desareca/fifa-19-analisis-de-caracteristicas-y-prediccion",label:"Kaggle"},{to:"https://rpubs.com/desareca/Analisis-estadisticas-FIFA19",label:"RPubs"}],logo:i.R,name:a.Fifa19,period:{from:new Date(2019,9,1),to:new Date(2019,9,31)},skills:n("r","tidyverse","ggplot2","h2o"),type:"Análisis de Datos",screenshots:[]},{slug:"prediccion-remuneracion-futbolistas",color:"steelblue",description:t.RemFut,shortDescription:"Predicción de remuneraciones de futbolistas a partir de estadísticas sobre sus habilidades de juego.",links:[{to:"https://github.com/desareca/Proyectos_tensorflow/tree/master/Remuneracion-Furtbolistas",label:"Repositorio"},{to:"https://rpubs.com/desareca/Prediccion-Sueldos-Futbolistas",label:"RPubs"}],logo:i.Python,name:a.RemFut,period:{from:new Date(2019,9,1),to:new Date(2019,9,31)},skills:n("python","pandas","numpy","matplotlib","seaborn","sklearn","tensorflow"),type:"Regresión",screenshots:[]},{slug:"clasificacion-infarto-cardiaco",color:"steelblue",description:t.InfCardiaco,shortDescription:"Clasificación binaria para predecir en base a las variables si un paciente con un determinado número de medidas médicas es susceptible de tener enfermedad de corazón o no.",links:[{to:"https://github.com/desareca/Proyectos_tensorflow/tree/master/Probabilidad-Infarto-Cardiaco",label:"Repositorio"},{to:"https://rpubs.com/desareca/Clasificacion-infarto-cardiaco",label:"RPubs"}],logo:i.Python,name:a.InfCardiaco,period:{from:new Date(2019,9,1),to:new Date(2019,9,31)},skills:n("python","pandas","numpy","matplotlib","sklearn","tensorflow"),type:"Clasificación",screenshots:[]},{slug:"analisis-consumidores-mall",color:"steelblue",description:t.ConsumMall,shortDescription:"Regresión para predecir el puntaje de los clientes en un mall.",links:[{to:"https://github.com/desareca/Proyectos_tensorflow/tree/master/Analisis-Consmidores",label:"Repositorio"},{to:"https://rpubs.com/desareca/Analisis_Consumidores",label:"RPubs"}],logo:i.Python,name:a.ConsumMall,period:{from:new Date(2019,9,1),to:new Date(2019,9,31)},skills:n("python","pandas","numpy","matplotlib","sklearn","tensorflow"),type:"Análisis de Datos",screenshots:[]},{slug:"analisis-sentimientos-noticieros-chilenos",color:"royalblue",description:t.NoticiaChile,shortDescription:"Twitter es actualmente una dinámica fuente de contenidos que, dada su popularidad e impacto, se ha convertido en uno de los principales medios de difusión de los principales medios de comunicación tradicionales (radio y televisión).",links:[{to:"https://github.com/desareca/Analisis-Sentimientos-Noticieros",label:"Repositorio"},{to:"https://rpubs.com/desareca/Analisis_Sentimientos_Noticieros",label:"RPubs"}],logo:i.R,name:a.NoticiaChile,period:{from:new Date(2019,5,1),to:new Date(2019,5,31)},skills:n("r"),type:"Análisis de Datos",screenshots:[]},{slug:"slick-portfolio-svelte",color:"#ff3e00",description:t.PortfolioSvelte,shortDescription:"A Vercel-like developer portfolio website template made with Typescript and SvelteKit.",links:[{to:"https://github.com/RiadhAdrani/slick-portfolio-svelte",label:"GitHub"}],logo:i.Svelte,name:a.PortfolioSvelte,period:{from:new Date},skills:n("svelte","ts","tailwind","sass"),type:"Svelte: Framework Moderno para Aplicaciones Web Eficientes",screenshots:[{label:"screen 1",src:"https://images.unsplash.com/photo-1587620962725-abab7fe55159?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZ3JhbW1pbmd8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"},{label:"2",src:"https://images.unsplash.com/photo-1516116216624-53e697fedbea?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8cHJvZ3JhbW1pbmd8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"},{label:"3",src:"https://images.unsplash.com/photo-1537432376769-00f5c2f4c8d2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHByb2dyYW1taW5nfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"},{label:"4",src:"https://images.unsplash.com/photo-1542903660-eedba2cda473?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHByb2dyYW1taW5nfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"},{label:"5",src:"https://images.unsplash.com/photo-1619410283995-43d9134e7656?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHByb2dyYW1taW5nfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"},{label:"6",src:"https://images.unsplash.com/photo-1585079542156-2755d9c8a094?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fHByb2dyYW1taW5nfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"}]}],_="Proyectos",E={title:_,items:j};export{E as P};
