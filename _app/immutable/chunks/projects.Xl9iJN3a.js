...
A continuacion se implementan mapas autorganizados para la reduccion dimensional, visualizacion de caracteristicas y clasificacion de imágenes, considerando dataset de números y de rostros.`,f=`El Juego de la vida es un autómata celular diseñado por el matemático británico John Horton Conway en 1970. Es un juego de cero jugadores, en el que su evolución es determinada por un estado inicial, sin requerir intervención adicional.
<br><br>
...
<br><br>
A continuación se presenta un análisis con visualización interactiva de los datos.`,I=`<div style="display: flex; justify-content: center; text-align: center;">
...
<br><br>
El objetivo es predecir cuándo ocurrirá la próxima erupción de un volcán, para ello se analiza un amplio conjunto de datos geofísicos recopilados por sensores instalados en volcanes activos, calculando features de las series temporales para entrenar un modelo XGBoost que prediga cuando será la próxima erupción.`,A=`<h1>Análisis Exploratorio e Inferencia para determinar estacionalidad en las ventas.</h1>
<br><br>
<div style="display: flex; justify-content: center; text-align: center;">
...
Además, sólo se consideran los meses de Diciembre, Enero y Febrero, debido a que este tipo de negocio es mayormente estacional y la simulación podría no ser necesariamente válida considerando un año completo.`,x=`<h1>Predicción de Ventas utilizando algoritmos de Machine Learning.</h1>
<br><br>
<div style="display: flex; justify-content: center; text-align: center;">
